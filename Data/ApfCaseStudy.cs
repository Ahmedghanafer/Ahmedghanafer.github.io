...
public static class ApfCaseStudy
{
    ...
    public static readonly IReadOnlyList<FlowNode> Pipeline = new[]
    {
        ...
        new FlowNode(
            ...
            Detail: "An in-process Python daemon thread on a fixed-rate 300-second timer. No cron, no Celery, no external "
                  ...
                  + "first pass is deliberately delayed by a full interval — boot is already contending with the catalogue "
        ...
        new FlowNode(
            Label: "Polling API",
            Detail: "ORDER BY rank_score DESC with explicit tiebreakers — rank_score alone has ties, and an unstable sort "
    ...
    public static readonly IReadOnlyList<EngineeringStory> Stories = new[]
    {
        new EngineeringStory(
            ...
            Problem:
                ...
                + "names. In a measured 129 MB response the largest single share was not the data — it was the keys, "
    ...
    public static readonly IReadOnlyList<(string Stage, string Items, string Combinations, string Rows, string Time, string Rss)> PrecomputeArc = new[]
    {
        ...
        ("All modes", "—", "—", "40,054", "32.3 s", "175 MB"),
    ...
    public static readonly IReadOnlyList<FactRow> Tradeoffs = new[]
    {
        ...
        new FactRow(
            ...
            + "are excluded because they were measured fast enough to render live — 80 and 95 combinations."),
